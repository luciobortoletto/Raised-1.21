...
public class RaisedScreen extends Screen {
    ...
    public IconToggleButton createIconToggleButton(Element element) {
        ...
        }, element == RaisedScreen.element).size(20, 20).texture(new ResourceLocation("raised:textures/gui/icon/" + element.getKey() + ".png"), 20, 20).tooltip(Tooltip.create(Component.translatable(element.getKey()))).build();
    }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        switch (element) {
            case HOTBAR -> {
                ...
                blit(poseStack, -182 - 1 + Mth.lerpInt(percentX, 5, 8) * 20, offset - 23, 0, 22, 24, 24);

                itemRenderer.renderAndDecorateItem(poseStack, Items.ENCHANTED_GOLDEN_APPLE.getDefaultInstance(), -182 + 123, offset - 19);
                itemRenderer.renderAndDecorateItem(poseStack, Items.GLISTERING_MELON_SLICE.getDefaultInstance(), -182 + 143, offset - 19);

                itemRenderer.renderGuiItemDecorations(poseStack, font, Items.ENCHANTED_GOLDEN_APPLE.getDefaultInstance(), -182 + 123, offset - 19, stringX);
                itemRenderer.renderGuiItemDecorations(poseStack, font, Items.GLISTERING_MELON_SLICE.getDefaultInstance(), -182 + 143, offset - 19, stringY);
            }
            case CHAT -> {
            ...
            case EFFECTS -> {
                ...
                RenderSystem.setShaderTexture(0, minecraft.getMobEffectTextures().get(MobEffects.LUCK).atlasLocation());
                blit(poseStack, -91 + 1 + 3, offset - 24 - 1 + 3, 0, 18, 18, minecraft.getMobEffectTextures().get(MobEffects.LUCK));
                RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, percentY);
                RenderSystem.setShaderTexture(0, minecraft.getMobEffectTextures().get(MobEffects.UNLUCK).atlasLocation());
                blit(poseStack, -91 + 1 + 3 + 24 + 1, offset - 24 - 1 + 3, 0, 18, 18, minecraft.getMobEffectTextures().get(MobEffects.UNLUCK));
            ...
            case TOASTS -> {
                ...
                itemRenderer.renderAndDecorateFakeItem(poseStack, Items.ENCHANTED_GOLDEN_APPLE.getDefaultInstance(), -91 + 8, offset - 32 + 8);
