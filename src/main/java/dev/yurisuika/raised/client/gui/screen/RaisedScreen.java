...
public class RaisedScreen extends Screen {
    ...
    public void init() {
        ...
        grid.add(new BooleanOption("options.raised.share", new TranslatableText("options.raised.share.tooltip"), gameOptions -> getShare(), (gameOptions, value) -> setShare(value)).createButton(client.options, 16, 104, 200));
