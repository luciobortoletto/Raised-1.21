...
public class RaisedScreen extends Screen {
    ...
    public void init() {
        ...
        addDrawableChild(CyclingOption.create("options.raised.share", new TranslatableText("options.raised.share.tooltip"), gameOptions -> getShare(), (gameOptions, option, value) -> setShare(value)).createButton(client.options, 16, 104, 200));
    }
