...
public abstract class RaisedScreen extends Screen {
    ...
    public void init() {
        ...
        share = new BooleanOption("options.raised.share", new TranslatableText("options.raised.share.tooltip"), gameOptions -> getShare(), (gameOptions, value) -> setShare(value)).createButton(client.options, (width / 2) - 100, 128, 200);
    }
