    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float delta) {
        ...
        switch (element) {
            case HOTBAR -> {
                ...
                drawTexture(matrixStack, -182 - 1 + MathHelper.lerp(percentX, 5, 8) * 20, offset - 23, 0, 22, 24, 24);

                itemRenderer.renderInGuiWithOverrides(matrixStack, Items.ENCHANTED_GOLDEN_APPLE.getDefaultStack(), -182 + 123, offset - 19);
                itemRenderer.renderInGuiWithOverrides(matrixStack, Items.GLISTERING_MELON_SLICE.getDefaultStack(), -182 + 143, offset - 19);

                itemRenderer.renderGuiItemOverlay(matrixStack, textRenderer, Items.ENCHANTED_GOLDEN_APPLE.getDefaultStack(), -182 + 123, offset - 19, stringX);
                itemRenderer.renderGuiItemOverlay(matrixStack, textRenderer, Items.GLISTERING_MELON_SLICE.getDefaultStack(), -182 + 143, offset - 19, stringY);
            }
            case CHAT -> {
            ...
            case TOASTS -> {
                ...
                itemRenderer.renderInGui(matrixStack, Items.ENCHANTED_GOLDEN_APPLE.getDefaultStack(), -91 + 8, offset - 32 + 8);
