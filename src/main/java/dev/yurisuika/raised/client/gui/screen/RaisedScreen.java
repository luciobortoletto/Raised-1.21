...
public class RaisedScreen extends Screen {
    ...
    public void init() {
        ...
        grid.add(SimpleOption.ofBoolean("options.raised.share", SimpleOption.constantTooltip(Text.translatable("options.raised.share.tooltip")), getShare(), RaisedConfig::setShare).createButton(client.options, 16, 104, 200));
