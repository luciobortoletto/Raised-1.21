...
public class IconToggleButtonWidget extends ButtonWidget {
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float delta) {
        if (texture != null) {
            ...
            drawNineSlicedTexture(matrixStack, getX(), getY(), getWidth(), getHeight(), 20, 4, 200, 20, 0, v);
            RenderSystem.setShaderTexture(0, texture);
    ...
    @Override
    public void drawMessage(MatrixStack matrixStack, TextRenderer textRenderer, int color) {}
